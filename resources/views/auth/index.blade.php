...
<body class="h-100">
    <div id="root" class="h-100">
        ...
        <div class="fixed-background"
            style="background-image:url('/assets/img/banner/baner.jpg'); background-position:cover;"></div>
        <!-- Background End -->
                            ...
                            <div class="hover-reveal-buttons position-relative hover-reveal cursor-default">
                                <div class="position-relative mb-3 mb-lg-5 rounded-sm">
                                    <img src="https://acorn.coloredstrategies.com/img/page/classic-dashboard.webp"
                                        class="/assets/img-fluid rounded-sm lower-opacity border border-separator-light"
                                        alt="card image" />
                                    <div
